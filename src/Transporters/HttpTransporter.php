...
{
    // Canonical /logs path. Server keeps /logs/ingest as a back-compat alias
    // so older SDK versions (<= 1.x) still work; alias removed once rolled out.
    const DEFAULT_HTTP_ENDPOINT  = 'https://observability.platform.uengage.in/logs';
    ...
    /**
     * @param array $config {
     *   @type string $endpoint        Optional. Default: https://observability.platform.uengage.in/logs
